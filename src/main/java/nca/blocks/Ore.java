...
public class Ore extends BlockFakeDiamondOre {
	...
	public Ore(String name, Material material) {
		this(name, material, null, 1, 2);
	}
	
	public Ore(String name, Material material, Item toDrop) {
		this(name, material, toDrop, 1, 2);
	}
	
	public Ore(String name, Material material, Item toDrop, int dropAmount) {
		this(name, material, toDrop, dropAmount, dropAmount);
	}
	
	public Ore(String name, Material material, Item toDrop, int minDropAmount, int maxDropAmount) {
		super(name,material);
		this.toDrop = toDrop;
